...
provider "registry.terraform.io/hashicorp/google" {
  version     = "5.45.2"
  constraints = ">= 3.33.0, >= 3.39.0, >= 3.53.0, >= 3.83.0, >= 4.25.0, >= 4.51.0, >= 4.64.0, >= 4.83.0, ~> 5.0, >= 5.9.0, >= 5.12.0, >= 5.26.0, < 6.0.0, < 7.0.0, < 8.0.0"
  hashes = [
...
provider "registry.terraform.io/hashicorp/google-beta" {
  version     = "5.45.2"
  constraints = ">= 3.53.0, >= 4.64.0, >= 4.83.0, >= 5.12.0, >= 5.26.0, < 6.0.0, < 7.0.0, < 8.0.0"
  hashes = [
